...
# Configure logging with proper file path and rotation
...
# Initialize Streamlit configuration with proper settings
st.set_page_config(
    ...
    menu_items={
        'Get Help': None,
        'Report a bug': None,
        'About': "SonarCloud Metrics Dashboard"
    }
)
...
def main():
    try:
        ...
        try:
            ...
            st.warning("Running in limited mode - database features temporarily disabled")
